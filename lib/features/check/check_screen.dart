...
class _CheckScreenState extends State<CheckScreen> {
  ...
  void _performCheck() async {
    ...
    // Simulate slight delay for "inspecting" feel
    ...
    if (isOnline) {
      // Use enhanced online check
      result = await TrueURLInspector.checkWithOnline(
        text,
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Offline mode • Connect to internet for deeper analysis'),
              ...
              label: FutureBuilder<bool>(
                ...
                builder: (context, snapshot) {
                  ...
                  return Text(
                    _isChecking 
                        ? 'Inspecting...' 
                        : online ? 'Check Now' : 'Check (Offline)',
                  );
                },
              ),
